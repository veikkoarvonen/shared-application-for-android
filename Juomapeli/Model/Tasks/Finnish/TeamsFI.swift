...
struct TeamsFITasks {
    ...
    static let tasks = [
        ...
        Task(
            template:         "{player1} vs. {player2}, molemmat seisomaan yhdellä jalalla! Pelaaja, jonka tasapaino pettää  Häviäjän joukkue ottaa {penalties} rankaisevaa",
            pointsToScore: 1,
            baselinePenalty: 4
        ),
        Task(
        ...
        Task(
            template:         "{team1}, teillä on 20 sekuntia aikaa sanoa 10 elokuvaa, jossa on puhuvia eläimiä. Jos onnistutte, vastustajajoukkue ottaa {penalties} rankaisevaa. Epäonnistuessanne otatte itse",
            pointsToScore: 1,
            baselinePenalty: 3
        ),
        Task(
